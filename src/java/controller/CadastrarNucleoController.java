...
public class CadastrarNucleoController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("relatorioNucleo.jsp");
            ...
            RequestDispatcher view = request.getRequestDispatcher("Cadastro/cadastrarNucleo.jsp");
            view.forward(request, response);
