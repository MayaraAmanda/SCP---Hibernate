...
public class CadastrarBolsistaController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("/relatorioBolsista_projeto.jsp");
            ...
            RequestDispatcher view = request.getRequestDispatcher("/Cadastro/cadastrarBolsista.jsp");
            view.forward(request, response);
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Campus campus = null;
            if(chaveCampus != 0){
                campus = Campus.obterCampus(chaveCampus);
                
            }
            
            Pessoas pessoa = new Pessoas(codigoPessoa, campus, nome, dataNascimento, estadoCivil, nacionalidade, ufNascimento, nomeMae, nomePai, naturalidade, grupoSanguineo, fatorRH, sexo, necessidadeEspecial, cor, escolaridade, rua, numero, complemento, bairro, cidade, cep, uf, pais, email, rg, orgaoExpedidor, tituloEleitor, numeroComprovanteMilitar, cpf, pisPasep, dataExpedicaoRG);
            Bolsista bolsista = new Bolsista(matricula, curso, projeto, pessoa, contaCorrente, nomeBanco, agencia );
