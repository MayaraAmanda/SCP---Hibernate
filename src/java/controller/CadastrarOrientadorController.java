...
public class CadastrarOrientadorController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("relatorioOrientador.jsp");
            ...
            RequestDispatcher view = request.getRequestDispatcher("Cadastro/cadastrarOrientador.jsp");
            view.forward(request, response);
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (codigoCampus != 0){
               ...
               Pessoas pessoas = new Pessoas(codigoPessoa, campus, nome, dataNascimento, estadoCivil, nacionalidade, ufNascimento, nomeMae, nomePai, naturalidade, grupoSanguineo, fatorRH, sexo, necessidadeEspecial, cor, escolaridade, rua, numero,complemento,bairro, cidade, cep, uf, pais,email, rg, orgaoExpedidor, tituloEleitor, numeroComprovanteMilitar, cpf, pisPasep, dataExpedicaoRG);
            
            Orientador orientador = new Orientador( matricula, pessoas, nucleo, homePageLattes);
