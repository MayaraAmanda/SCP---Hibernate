...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("relatorioProjeto.jsp");
            ...
            RequestDispatcher view = request.getRequestDispatcher("Cadastro/cadastrarProjeto.jsp");
            view.forward(request, response);
     ...
     private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        int duracaoProjeto = Integer.parseInt(request.getParameter("duracaoProjeto"));
        ...
        try {
           ...
           Projeto projeto = new Projeto(codigoProjeto, nomeProjeto, cargaHoraria, palavraChave, duracaoProjeto, dataInicio, dataTermino, valorfinanciamento, dataFinanciamento, programa, agenciaFomento, quantidadeBolsa, instituicaoParceira,  grupoPesquisaCNPq, coOrientador, tipoBolsa, edital,  subArea, coordenador);
