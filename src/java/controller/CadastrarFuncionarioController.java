...
public class CadastrarFuncionarioController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("relatorioFuncionario.jsp");
            ...
            RequestDispatcher view = request.getRequestDispatcher("Cadastro/cadastrarFuncionario.jsp");
            view.forward(request, response);
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Funcionario funcionario = new Funcionario( matricula, pessoas, instituicao);
