...
public class CadastrarCursoController extends HttpServlet {
    ...
    protected void prepararOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("Cadastro/cadastrarCurso.jsp");
            view.forward(request, response);
...
private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Curso curso = new Curso(codigoCurso, nomeCurso, instituicao, coordenador, tipocurso, campus);
