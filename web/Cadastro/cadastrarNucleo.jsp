                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="number" required name="codigoNucleo" value="${nucleo.codigoNucleo}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>Núcleo:
                            <input type="text" required name="nomeNucleo" value="${nucleo.nomeNucleo}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>><br><br></label>
                        </td>
                    </tr>
                </table> 
            </center>
