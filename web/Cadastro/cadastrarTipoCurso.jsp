            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="number" required name="codigoTipoCurso" value="${tipoCurso.codigoTipoCurso}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" required name="nomeTipoCurso" value="${tipoCurso.nomeTipoCurso}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </td>
                    </tr> 
                </table>
                        </center>
