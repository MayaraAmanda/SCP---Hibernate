            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="number" required name="codigoTipoBolsa" value="${TipoBolsa.codigoTipoBolsa}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>><br><br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" required name="nomeTipoBolsa" value="${TipoBolsa.nomeTipoBolsa}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>><br><br>
                        </td>
                    </tr> 
                </table><br/><br/>
                </center>
